...
class Sensors:
    ...
    def __init__(self, debug, storageWarningThreshold, phoneNumbers, phoneNumbersKeys):
        ...
        self.Mot = None
        self.Weig = None
        self.storageWarningThreshold = storageWarningThreshold # 90
        self.phoneNumbers = phoneNumbers # as a list of integers
        self.phoneNumbersKeys = phoneNumbersKeys # as a list of integers
    ...
    def saveSensorData(self, header_A: list, header_B: list,
        ...
        while True:
            ...
            if time_StorageWarning >= setTimeForStorageWarning:
                ...
                if storage_percentage_used > self.storageWarningThreshold:
...
#                 if i read weight in less than 10 min ago then sleep
    ...
    def sendMessage(self, msg: str):
        try:
            ...
            # 25 msg per 240 min
            for phoneNumber, apiKey in zip(self.phoneNumbers, self.phoneNumbersKeys):
                self.printDebug(f'Sending message to {phoneNumber}.', self.debug)
    #             https://api.callmebot.com/whatsapp.php?source=web&phone=+35799008615&apikey=105567&text=Warning:%20CPU%20Temperature%2050%20Celcius.
                requests.get(f'https://api.callmebot.com/whatsapp.php?source=web&phone=+{phoneNumber}&apikey={apiKey}&text={msg}')
        except:
